...
//            Log.d(TAG, "向上滚动");
    ...
    private void refreshItemView(int y) {
        int position = y / itemHeight + offset;System.out.println("remainder:="+position);
        int remainder = y % itemHeight;System.out.println("remainder:="+remainder);
    ...
    public void setBackgroundDrawable(Drawable background) {
        ...
        background = new Drawable() {
            ...
            public void draw(Canvas canvas) {
                ...
                canvas.drawCircle(viewWidth * 1 / 2, (obtainSelectedAreaBorder()[0] + obtainSelectedAreaBorder()[1]) / 2, 100, paint);
